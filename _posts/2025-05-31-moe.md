...
layout: post
permalink: /blog/moe/
description: "Sparsely-Gated Mixture-of-Experts를 통한 최소 연산 오버헤드로 1000배 파라미터 확장."
tags: mixture-of-experts
thumbnail: assets/img/blog/moe.png
related_posts: true
...
- [GPipe](/blog/pp/) - MoE와 결합 가능한 파이프라인 병렬화

**분산 훈련:**
- [Tensor Parallelism](/blog/tp/) - MoE와 호환되는 텐서 병렬화 기법
- [Reducing Activation Recomputation in Large Transformer Models](/blog/sp/) - 대규모 MoE 훈련을 위한 메모리 최적화

**확장성 및 효율성:**
- [Efficiently Scaling Transformer Inference](https://arxiv.org/pdf/2211.05102) - MoE 모델의 효율적 추론
- [USP](/blog/usp/) - MoE와 결합 가능한 시퀀스 병렬화
