...
**관련 프레임워크:**
- [Scaling LLM Pre-Training with TorchTitan](https://arxiv.org/pdf/2410.06511) - PyTorch 네이티브 대규모 학습 프레임워크
- [veScale](https://arxiv.org/pdf/2509.07003) - Eager Mode SPMD 기반 텐서 프로그래밍
- [Pre-Training LLMs with FP8](https://arxiv.org/pdf/2412.12877) - FP8 혼합 정밀도 사전학습
