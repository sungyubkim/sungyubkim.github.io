...
**모델 병렬화 기법:**
- [GPipe]({% post_url 2025-05-30-pp.md %}) - 파이프라인 병렬화를 통한 대규모 모델 훈련
- [[Reducing Activation Recomputation in Large Transformer Models]] - 메모리 효율적인 병렬 훈련 기법
- [[Sequence Parallelism - Long Sequence Training from System Perspective]] - 시퀀스 차원 병렬화
...
**어텐션 확장:**
- [[RingAttention]] - 링 토폴로지를 활용한 어텐션 분산
