...
tags: memory-efficiency sequence-parallelism
related_posts: true
...
**메모리 최적화 기법:**
- [Tensor Parallelism](/blog/tp/) - 텐서 병렬화와 메모리 효율성 결합
- [GPipe](/blog/pp/) - 파이프라인 병렬화에서의 메모리 최적화
- [Ring Self-Attention](/blog/ring-self-attention/) - 시퀀스 병렬화와 메모리 관리

**대규모 모델 훈련:**
- [Switch Transformers](https://arxiv.org/pdf/2101.03961) - 대규모 MoE 모델의 메모리 효율성
- [MoE](/blog/moe/) - 전문가 혼합 모델의 메모리 요구사항
- [LoongTrain](https://arxiv.org/pdf/2406.18485) - 긴 시퀀스 훈련에서의 메모리 최적화

**분산 훈련 시스템:**
- [DeepSpeed Ulysses](/blog/deepspeed_ulysses/) - 시퀀스 병렬화와 메모리 효율성
- [USP](/blog/usp/) - 통합 병렬화 프레임워크에서의 메모리 관리
- [Blockwise RingAttention](/blog/blockwise_ringattention/) - 어텐션 계산의 메모리 효율성
